            ...
            <div class="content-wrapper">
                <div class="page-header page-header-default">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i
                        ...
                        {{--<ul class="breadcrumb">--}}
                            {{--<li><a href="{{url('/')}}"><i class="icon-home2 position-left"></i>خانه</a></li>--}}
                                        ...
                                        <div class="panel panel-flat blog-horizontal blog-horizontal-2">
                                            <div class="panel-body">
                                                ...
                                                <div class="blog-preview">
                                                    ...
                                                    <p>{{substr($sub_project->summery,0,40)}}<a href="#description{{$sub_project->id}}" data-toggle="collapse" >[بیشتر]</a></p>
