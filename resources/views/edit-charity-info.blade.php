            ...
            <form class="form-horizontal form-validate-jquery" action="{{route('charity-update',['id'=>$charity->id])}}"
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="5" cols="5" name="address" class="form-control" required="required"
                                      ...
                                      aria-required="true">{{$charity->address}}</textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="5" cols="5" name="biography" class="form-control" required="required"
                                      ...
                                      aria-required="true">{{$charity->bio}}</textarea>
                        </div>
                    </div>
                    <!-- Basic text input -->
                    <div class="form-group">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" placeholder="ادرس سایت یا شبکه اجتماعی را وارد کنید"
                                   value="{{$charity->site}}" name="site">
